...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ic6x474.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ic6x474.containers.anotherwebservice.com/
...
```
git clone git@github.com:ParvathiRNair/container-ic6x474.git
cd container-ic6x474
```
...
```
docker attach container-ic6x474
```
